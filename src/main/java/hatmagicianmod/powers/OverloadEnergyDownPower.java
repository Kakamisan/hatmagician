...
public class OverloadEnergyDownPower extends AbstractPower {
    ...
    static {
        POWER_ID = ModHelper.makeID("OverloadEnergyDownPower");
        powerStrings = CardCrawlGame.languagePack.getPowerStrings(POWER_ID);
        NAME = powerStrings.NAME;
        DESCRIPTIONS = powerStrings.DESCRIPTIONS;
    }

    public OverloadEnergyDownPower(AbstractCreature owner, int Amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
