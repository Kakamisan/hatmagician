package hatmagicianmod.characters;
...
//        retVal.add(Spin.ID);
    ...
    public AbstractCard.CardColor getCardColor() {
        return PlayerColorEnum.HAT_MAGICIAN_YELLOW;
    }
    ...
    public Color getCardTrailColor() {
        return HatMagicianMod.MY_COLOR;
    }
    ...
    public static class PlayerColorEnum {
        ...
        @SpireEnum
        public static PlayerClass CHARACTER_HAT_MAGICIAN;

        // ***将CardColor和LibraryType的变量名改为你的角色的颜色名称，确保不会与其他mod冲突***
        // ***并且名称需要一致！***
        @SpireEnum
        public static AbstractCard.CardColor HAT_MAGICIAN_YELLOW;
    }
